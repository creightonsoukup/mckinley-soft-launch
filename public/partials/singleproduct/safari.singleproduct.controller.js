angular.module('MyApp')
  ...
  .controller('SingleProduct', function ($scope, $location, $http, $routeParams, shopifyService, quotesService) {
    ...
    $scope.view.addToCart = function (quantity)  {
    ...
    $scope.view.togglePhotoLeft = function ()  {
      $scope.view.currentImage = $scope.view.productImages[0].src
    ...
    $scope.view.togglePhotoRight = function ()  {
    ...
    $scope.view.setPhotoCount = function ()  {
    ...
    $scope.view.showProductDetails = function ()  {
